...
import { Briefcase, Calendar, Users, FileText, LogOut } from 'lucide-react-native';
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          <View>
            <Text style={styles.welcomeText}>Department Portal</Text>
            <Text style={styles.subText}>OMBARO Department Dashboard</Text>
          </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <View style={styles.section}>
          ...
          <QuickActionCard
            ...
            subtitle="Manage department activities"
            onPress={() => {}}
          />
          ...
          <QuickActionCard
            ...
            subtitle="View department schedule"
            onPress={() => {}}
          />
          ...
          <QuickActionCard
            ...
            subtitle="Access department reports"
            onPress={() => {}}
          />
        </View>
      </ScrollView>
